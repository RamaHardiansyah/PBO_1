...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        # pasang Label
        Label(mainFrame, text='Masukkan teks:', bg="yellow").grid(row=0, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Jawa:', bg="yellow").grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Sunda:', bg="yellow").grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Jepang:', bg="yellow").grid(row=6, column=0,
            sticky=W, padx=5, pady=5)
        ...
        Label(mainFrame, text='Rama Hardiansyah:', bg="yellow").grid(row=8, column=1, pady=5, padx=5)

        # Pasang Button
        self.btnTranslate = Button(mainFrame, text='Translate!',
            command=self.onTranslate, bg="yellow")
    ...
    def onTranslate(self):
        ...
        # menterjemahkan
        hasil = penterjemah.translate(self.txtSumber.get(), src='id', dest='jw') 
